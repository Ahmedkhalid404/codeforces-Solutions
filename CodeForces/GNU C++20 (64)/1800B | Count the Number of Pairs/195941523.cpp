...
int main() {
    ...
    while(tt--)
    {
        ...
        for(auto it : unique)
        {
            if( k )
            {
                if( abs( freq[ it ] - freq[(it - ('a' - 'A' )) ]) > 1 )
                {
                    while( k && ( abs( freq[ it ] - freq[ it - ('a' - 'A' ) ]) > 1 ) )
                    {
                        if( freq[ it ] > freq[(it - ('a' - 'A' )) ] )
                        {
                            freq[(it - ('a' - 'A' )) ]++;
                            freq[it]--;
                        }
            ...
            result = result + (ll)min( freq[it] , freq[ (it - ('a' - 'A' )) ]  );
        }
        cout<<result<<ln;
    }
    //********** code ***************

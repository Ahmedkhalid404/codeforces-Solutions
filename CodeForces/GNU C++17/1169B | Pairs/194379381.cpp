...
int main() {
    ...
    x[0] = numbers[0].first;
    x[1] = numbers[0].second;
    for (int i = 0; i < size; ++i) {
        if( (x[0] != numbers[i].first) && (x[0] != numbers[i].second) && (x[1] != numbers[i].first) && (x[1] != numbers[i].second) )
        {
            y[0] = numbers[i].first;
            y[1] = numbers[i].second;
            goto jump;
        }
    }
    return Yes,0;
        ...
        for (int i = 0; i < 2; ++i) {
            for (int j = 0; j < 2; ++j) {
                for (int k = 0; k < size; ++k) {
                    if( (x[i] != numbers[k].first) && (x[i] != numbers[k].second) && (x[i] != numbers[k].first) && (x[i] != numbers[k].second) && /* ---> */ (y[j] != numbers[k].first) && (y[j] != numbers[k].second) && (y[j] != numbers[k].first) && (y[j] != numbers[k].second))
                    {
                        break;
                    }
                    if( k == size - 1 )
